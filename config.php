...
$smtpPort = 465;
$smtpUsername = "contactForm@myUsername.com";
...
*/
$fromAddress = "contactForm@myUsername.com";
$toAddress = "info@myCompany.com"; // This is the address (your address) that the email will be sent to when the contact form is submitted.
